...
import 'package:rick_and_morty/core/di/modules/util_module.dart' as _i40;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i25.CharacterMapper>(() => _i25.CharacterMapper(
          gh<_i21.StatusMapper>(),
          gh<_i13.GenderMapper>(),
        ));
    gh.lazySingleton<_i26.CharactersRepository>(
        () => _i27.CharactersRepositoryImpl(
              gh<_i18.RemoteCharactersDataSource>(),
              gh<_i15.LocalCharactersDataSource>(),
              gh<_i25.CharacterMapper>(),
              gh<_i21.StatusMapper>(),
              gh<_i13.GenderMapper>(),
              gh<_i17.PaginationInfoMapper>(),
            ));
    gh.lazySingleton<_i28.ConnectionBroadcaster>(
        () => _i29.ConnectionBroadcasterImpl(gh<_i4.ConnectionInspector>()));
    gh.factory<_i30.GetCharacters>(
        () => _i30.GetCharacters(gh<_i26.CharactersRepository>()));
    gh.factory<_i31.GetConnectionStatus>(
        () => _i31.GetConnectionStatus(gh<_i28.ConnectionBroadcaster>()));
    gh.factory<_i32.GetConnectionStatusStream>(
        () => _i32.GetConnectionStatusStream(gh<_i28.ConnectionBroadcaster>()));
    gh.factory<_i33.GetLocalCharacters>(
        () => _i33.GetLocalCharacters(gh<_i26.CharactersRepository>()));
    gh.factory<_i34.IsFavoriteCharacter>(
        () => _i34.IsFavoriteCharacter(gh<_i26.CharactersRepository>()));
    gh.factory<_i35.SaveCharactersToDatabase>(
        () => _i35.SaveCharactersToDatabase(gh<_i26.CharactersRepository>()));
    gh.factory<_i36.UpdateLocalCharacter>(
        () => _i36.UpdateLocalCharacter(gh<_i26.CharactersRepository>()));
    gh.factory<_i37.CharacterDetailsStore>(() => _i37.CharacterDetailsStore(
          gh<_i23.AddToFavorites>(),
          gh<_i19.RemoveFromFavorites>(),
          gh<_i36.UpdateLocalCharacter>(),
          gh<_i34.IsFavoriteCharacter>(),
          gh<_i31.GetConnectionStatus>(),
          gh<_i30.GetCharacters>(),
          gh<_i33.GetLocalCharacters>(),
        ));
    gh.factory<_i38.CharactersListStore>(() => _i38.CharactersListStore(
          gh<_i30.GetCharacters>(),
          gh<_i23.AddToFavorites>(),
          gh<_i19.RemoveFromFavorites>(),
          gh<_i33.GetLocalCharacters>(),
          gh<_i35.SaveCharactersToDatabase>(),
          gh<_i34.IsFavoriteCharacter>(),
          gh<_i36.UpdateLocalCharacter>(),
          gh<_i31.GetConnectionStatus>(),
          gh<_i32.GetConnectionStatusStream>(),
        ));
    gh.factory<_i39.FavoritesStore>(() => _i39.FavoritesStore(
...
class _$UtilModule extends _i40.UtilModule {}
